...
class PirateTest < Minitest::Test
  ...
  def test_a_pirate_can_rob_ships
    # skip
    pirate = Pirate.new("Jack") # create a pirate
    assert pirate.rob_ship # check that a pirate has a rob_ship method
  end

  def test_a_pirate_has_booty
    # skip
    pirate = Pirate.new("Jack") # create a pirate
    assert_equal 0, pirate.booty # pirate starts with 0 booty
  end

  def test_a_pirate_gets_100_booty_for_robbon
    # skip
    pirate = Pirate.new("Jack") # create a pirate
    pirate.rob_ship # pirate robs ship
    assert_equal 100, pirate.booty # check pirate has 100 booty
  end
